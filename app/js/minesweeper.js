...
const createContainer = () => {
    ...
    levelSwitchMedium.addEventListener('click', function (e) {
        mediumLevel();
    });

    levelSwitchHard.addEventListener('click', function (e) {
        hardLevel();
    });
    ...
    if (!localStorage.getItem('final') || localStorage.getItem('final') === '0') {
        ...
        [...uniqueActiveItem].forEach(el => {
            ...
            if (el.className.substring(10,19).trim() === 'bomb-boom'){
                isGameOver = true;
                startTimer = true;
            }
...
//save result of game for the table
